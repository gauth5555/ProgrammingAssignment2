## These 2 functions will calculate the inverse matrix or retreive the inverse 
...
## (4)They don't calculate the mean, they simply store the value of the input 
## in a variable m.
...
##with makeCacheMatrix, m calculates the inverse, and x$setmean(m) stores 
